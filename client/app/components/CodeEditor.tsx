    ...
    <div className="flex-1 h-full bg-background flex flex-col">
        ...
        <div className="flex-1 p-8 font-mono text-sm relative overflow-hidden">
            ...
            <div className="pl-16 text-gray-300 leading-6">
                <span className="text-pink-500">fn</span> <span className="text-blue-400">main</span>() {'{'} <br/>
                &nbsp;&nbsp;<span className="text-gray-500">// Initialize the collaborative engine</span><br/>
                &nbsp;&nbsp;<span className="text-pink-500">let</span> <span className="text-orange-400">app</span> = <span className="text-blue-400">Router::new</span>();<br/>
                &nbsp;&nbsp;<span className="text-blue-400">println!</span>(<span className="text-green-400">"Server running on port 8080"</span>);<br/>
                {'}'}
            </div>
